    ...
    <div className="relative w-[90vw] laptop:w-[52.6rem]">
      ...
      <div className="flex flex-col justify-center py-[15px] dark:rounded-b-[0.5rem] dark:border dark:border-gray-100 tablet:py-[25px] dark:tablet:rounded-b-[1.5rem]">
        <div className="px-[20px] laptop:px-[80px]">
          <p className="mb-[10px] text-[12px] font-medium leading-[13.56px] text-gray-1 dark:text-gray-300 tablet:mb-5 tablet:text-[16px] tablet:leading-normal">
            {createCustom
              ? 'Custom Link Address'
              : 'This post is now shared. Sharing posts helps broaden your reach. The more engagement your shares receive, the more FDX you earn. Shared posts are displayed on your Home Page for all to see. '}
          </p>
          <p className="mb-[10px] text-[12px] font-medium leading-[13.56px] text-gray-1 dark:text-gray-300 tablet:mb-5 tablet:text-[16px] tablet:leading-normal">
